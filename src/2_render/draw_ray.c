...
/*   Updated: 2025/07/11 15:37:34 by lifan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->br.x0 = (int)game->player->m_xp + game->size_mini_player / 2.0;
	game->br.y0 = (int)game->player->m_yp + game-> size_mini_player / 2.0;
	game->br.x1 = (int)x1;
	game->br.y1 = (int)y1;
	init_draw_line(game);
	draw_line(game, RAY);
